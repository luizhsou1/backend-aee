...
export class UpdateStudentDto {
  ...
  @IsStudentAeeRegistration(false)
  aeeRegistration: string;

  @IsStudentRegularRegistration(false)
  regularRegistration: string;

  @IsStudentBirthDate(false)
  birthDate: string;
  ...
  @IsStudentShift(false)
  regularShift: Shift;

  @IsStudentRegularClassYear(false)
  regularClassYear: number;

  @IsStudentRegularClass(false)
  regularClass: string;

  @IsStudentRegularClassRoom(false)
  regularClassRoom: number;

  @IsStudentAeeClass(false)
  aeeClass: string;
